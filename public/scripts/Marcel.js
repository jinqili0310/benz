var icon_img = 'https://jinqili0310.github.io/assets/mercedes/Marcel_icon.png';
var playAd = 0;
var bye = 0;
	...
	if (answer_text == answer[correct_index]) {
		if (next_question > -1) {
			...
			if (text.indexOf('gif') > -1) {
				...
				newNode.appendChild(document.createTextNode('  Marcel is typing...'));
...
function displayBot() {
	...
	if (user_name == '') {
		setTimeout(function() {
			postBotAnswer('Hello, car connoisseur! I am Marcel, Mercedes-Benz’s chatbot powered by artificial intelligence. What is your name?');
		}, 500);
	}
}
